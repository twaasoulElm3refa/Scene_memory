<template>
  ...
  >
    ...
    <div
      class="auth-container position-relative z-2 d-flex flex-column flex-lg-row w-100 h-100"
    >
      <!-- Left branding side -->
      <div
        class="d-none d-lg-flex col-lg-5 align-items-center justify-content-center p-5 position-relative"
      >
        <div class="text-center">
          <img
            src="/images/event_logo.png"
            alt="NEXTLEVEL Logo"
            class="height-auto logo-glow"
            style="width: auto"
          />
      ...
      <!-- Form side -->
      <div
        class="col-12 col-lg-7 d-flex align-items-center justify-content-center p-4 p-md-5"
      >
        <div
          class="glass-card rounded-4 shadow-glow p-4 p-md-5 w-100"
        ...
        >
          ...
          >
            <ul class="nav nav-pills nav-fill">
              <li class="nav-item text-center flex-grow-1">
                <button
                  class="nav-link px-0 fs-5 fw-semibold position-relative"
          ...
          >
            ...
            <div class="input-group input-group-lg">
              ...
              />
              <span
                class="input-group-text glass-input rounded-3 border-start-0"
            ...
            <button
              type="submit"
              class="btn btn-glow btn-lg rounded-3 py-3 fw-bold fs-5 mt-3"
              :disabled="loading"
            >
            ...
            <p class="text-right">
              <a
                href="#"
                class="text-glow fw-medium fs-6"
          ...
          <form v-else @submit.prevent="handleRegister" class="d-flex flex-column gap-4">
            ...
            <button
              type="submit"
              class="btn btn-glow btn-lg rounded-3 py-2 fw-bold fs-5 mt-3"
              :disabled="loading"
            >
          ...
          <div class="text-center mt-4 text-white fs-6">
            <span v-if="tab === 'register'">
              ...
              <a href="#" class="text-glow fw-medium" @click.prevent="tab = 'login'"
                >Login</a
              >
            </span>
            <span v-else>
              Don't have an account?
              <a href="#" class="text-glow fw-medium" @click.prevent="tab = 'register'"
                >Register</a
              >
            </span>
          </div>
