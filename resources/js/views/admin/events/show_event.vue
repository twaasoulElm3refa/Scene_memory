        ...
        <div class="show-event-container" v-if="event">
            ...
            <div class="header">
                <div class="breadcrumb">
                    <router-link to="/admin/events" class="breadcrumb-link">جميع الاحداث</router-link>
            ...
            <div class="title-section">
                <h1 class="event-title">{{ event.translation.title }}</h1>
            ...
            <div class="content-grid">
                ...
                <div class="left-column">
                    ...
                    <div class="event-image-card">
                        <!-- Event Image -->
                        <div class="event-image-card">
                            <img :src="getMainImage() || fallbackImage" :alt="event.title" class="event-image"
                                loading="lazy" />
                            ...
                        </div>
                    ...
                    <div class="overview-card">
                        ...
                        <p class="event-description">{{ event.translation.description }}</p>
                    ...
                    <div class="info-card">
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-2 bg-red-50 px-3 py-1.5 rounded-full">
                                <svg class="text-red-500" width="18" height="18" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path
                                        d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                                </svg>
                                <span class="font-medium text-red-600 dark:text-red-400">{{ event.likes_count || 0
                                    }}</span>
                                <span>Likes</span>
                            </div>

                            <div class="flex items-center gap-2 bg-blue-50 px-3 py-1.5 rounded-full">
                                <svg class="text-blue-500" width="18" height="18" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path
                                        d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z" />
                                </svg>
                                <span class="font-medium text-blue-600 dark:text-blue-400">{{ event.comments_count || 0
                                    }}</span>
                                <span>Comments</span>
                            </div>

                            <div class="flex items-center gap-2 bg-green-50 px-3 py-1.5 rounded-full">
                                <svg class="text-green-600" width="18" height="18" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path
                                        d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" />
                                </svg>
                                <span class="font-medium text-green-700 dark:text-green-400">{{ event.views_count || 0
                                    }}</span>
                                <span>Views</span>
                            </div>
                        </div>
            ...
            <div class="images-gallery" v-if="event.images?.length > 1">
                ...
                <div class="gallery-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <div v-for="(media, index) in event.images" :key="media.id"
                        ...
                        <button @click.stop.prevent="confirmDeleteMedia(media.id)"
            ...
            <div v-if="isModalOpen"
                ...
                @click="closeModal">
                <button class="absolute top-6 right-6 z-10 text-white text-5xl hover:text-gray-300 transition-colors"
                    @click.stop="closeModal">
                    ×
                </button>

                <img v-if="selectedMedia && !isVideo(selectedMedia.url)" :src="getSafeUrl(selectedMedia.url)"
                    :alt="event.title" class="max-w-[95vw] max-h-[90vh] object-contain shadow-2xl" @click.stop />

                <video v-else-if="selectedMedia && isVideo(selectedMedia.url)" :src="getSafeUrl(selectedMedia.url)"
                    controls autoplay loop muted class="max-w-[95vw] max-h-[90vh] object-contain shadow-2xl"
                    @click.stop>
                    المتصفح لا يدعم عرض الفيديو
                </video>

                <img v-else :src="fallbackImage" class="max-w-[95vw] max-h-[90vh] object-contain" />
                ...
                <button v-if="selectedIndex < event?.images?.length - 1"
            ...
            <div v-if="isAddMediaModalOpen"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-lg w-full overflow-hidden"
                    ...
                    <div class="p-6 space-y-6">
                        <div>
                            <label class="block text-sm font-medium mb-2">اختر ملف (صورة أو فيديو)</label>
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-8 text-center cursor-pointer hover:border-blue-500 transition-colors"
                                ...
                                <div v-else class="space-y-3">
                                    ...
                                    <button type="button" class="text-red-600 hover:text-red-800 text-sm underline"
                    ...
                    <div class="p-6 border-t dark:border-gray-700 flex justify-end gap-3">
                        <button @click="closeAddMediaModal"
                        ...
                        <button @click="uploadMedia"
                            ...
                            <svg v-if="uploading" class="animate-spin h-5 w-5" xmlns="http://www.w3.org/2000/svg"
