              ...
              <div class="row g-3">
                <div class="col-12">
                  ...
                  <input v-model="form.title" type="text"
                    ...
                    :placeholder="$t('eventForm.eventTitle') + ' ' + $t('commons.choose')" required />
                </div>
                ...
                <div class="col-12">
                  ...
                  <textarea v-model="form.description" class="form-control rounded-3" rows="5"
                    :placeholder="$t('eventForm.description') + '، ' + $t('eventForm.basicInfo').toLowerCase() + '، ' + $t('eventForm.locationCategory').toLowerCase() + '...'" required
