        ...
        <div v-else class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            <div v-for="(plan, index) in plans" :key="plan.id" :class="[
                ...
                <div class="mt-2 mb-8">
                    ...
                    <span v-if="plan.price !== '0.00'" class="text-sm ml-1 text-gray-500"
                ...
                <ul class="flex-1 space-y-3 mb-8">
                    ...
                    <li v-for="adv in plan.advantges" :key="adv.id"
                        ...
                        {{ adv.translation?.name || adv.name }}
                    </li>
                </ul>

                <button @click="goToPlan(plan)" :class="[
