    ...
    <div class="min-h-screen bg-gray-50 font-sans">
        ...
        <div class="bg-white border-b ml-10 shadow-sm top-0 z-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7 gap-2 items-end">
                    <!-- Category -->
                    <div class="space-y-1">
                    ...
                    <div>
                        <select v-model="selectedCity" :disabled="!selectedCountry"
                            ...
                            <option v-for="city in cities" :key="city.id" :value="city.id" class="text-gray-900">
