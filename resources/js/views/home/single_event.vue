                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-0">
                        ...
                        <div class="lg:col-span-2 p-8 md:p-12 lg:p-16">
                            ...
                            <div class="comments-section">
                                ...
                                <RouterLink :to="{ name: 'all_comments', params: { slug: event.slug } }"
                                    class="view-all-btn">
                                    {{ $t('view_all_comments') }}
                                </RouterLink>
                                <div v-for="comment in event.comments" :key="comment.id" class="comment-box">
                                    <div class="comment-content ">
                                        ...
                                        <button v-if="comment.user_id === currentUserId"
                                            @click="deleteComment(comment.id)" class="delete-btn"
                                ...
                                <div class="comment-form">
                                    ...
                                    <form @submit.prevent="addComment">
                                        <textarea v-model="newComment" rows="3" class="comment-textarea"
                                            :placeholder="$t('event.comment_placeholder')" :disabled="commentLoading"
                                            required></textarea>
